	...
	<div class="myOrder clear" id="body_box">
		 <div class="weui_tab">
			<div class="weui_navbar">
				<div class="weui_navbar_item one weui_bar_item_on" v-on:click="classdata('0')">待付款</div>
				<div  class="weui_navbar_item two" v-on:click="classdata('1')"> 待收货</div>
				<div class="weui_navbar_item three" v-on:click="classdata('2')"> 待评价</div>
				<div class="weui_navbar_item four" v-on:click="classdata('3')">  退款</div>
			</div>
								 ...
								 <div  id="nopay-order" class="weui_tab_bd_item weui_tab_bd_item_active">
										 ...
										 <a v-on:click="jump_url(item.product_id,item.url)" class="weui-media-box weui-media-box_appmsg clear">
											...
											<div class="order-foot float-right"><!--共<span>1</span>件产品，-->
												合计<span>{{item.pay_price}}</span>元（含运费<span></span>元）
											</div>
