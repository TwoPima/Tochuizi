				        ...
				        <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
				            ...
				            <div class="weui-media-box__bd">
				              <!--   <h4 class="weui-media-box__title"></h4> -->
				                <p class="weui-media-box__desc margin-bottom-10px">宁夏亿次元科技有限公司</p>
				                <p class="weui-media-box__desc margin-bottom-10px">宁夏银川市西夏区801创业孵化基地</p>
				                <p class="weui-media-box__desc">15909581102</p>
				            </div>
				        </a>
				    </div>
				</div>
